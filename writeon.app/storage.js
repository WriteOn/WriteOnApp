...
define([
    ...
    if(version == "v7" || version == "v8" || version == "v9") {
        if(_.has(localStorage, 'settings')) {
            ...
            settings.template && (settings.template = settings.template.replace('http://writeon.io/css/main-min.css', 'http://writeon.io/writeon/themes/neat.css'));
    ...
    if(version == "v10") {
        if(_.has(localStorage, 'settings')) {
            ...
            settings.template && (settings.template = settings.template.replace('http://writeon.io/lib/', 'https://writeon.io/libs/'));
            settings.template && (settings.template = settings.template.replace('http://writeon.io/', 'https://writeon.io/'));
            settings.pdfTemplate && (settings.pdfTemplate = settings.pdfTemplate.replace('http://writeon.io/lib/', 'https://writeon.io/libs/'));
            settings.pdfTemplate && (settings.pdfTemplate = settings.pdfTemplate.replace('http://writeon.io/', 'https://writeon.io/'));
            settings.defaultContent && (settings.defaultContent = settings.defaultContent.replace('http://writeon.io/', 'https://writeon.io/'));
            settings.commitMsg && (settings.commitMsg = settings.commitMsg.replace('http://writeon.io/', 'https://writeon.io/'));
            localStorage.settings = JSON.stringify(settings);
        }
        version = "v11";
    }
    ...
    if(version == "v11") {
        ...
        if(_.has(localStorage, 'settings')) {
            ...
            delete settings.editorFontFamily;
            delete settings.editorFontSize;
            settings.template && (settings.template = settings.template.replace('https://writeon.io/writeon/themes/default.css', 'https://writeon.io/writeon/themes/base.css'));
            settings.pdfTemplate && (settings.pdfTemplate = settings.pdfTemplate.replace('https://writeon.io/writeon/themes/default.css', 'https://writeon.io/writeon/themes/base.css'));
            localStorage.settings = JSON.stringify(settings);
        }
        version = "v12";
    }
