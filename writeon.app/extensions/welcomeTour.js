		...
		tour.addSteps([
			{
				...
				content: [
					'<p>Hi there! Since you\'re new here, let\'s take a look around. First things first...with WriteOn, <i class="icon-pencil-squared"> <strong>Pad</strong></i> is where you write, and <i class="icon-doc-text"> <strong>Paper</strong></i> is were you review.</p>',
					'Tap <b>Next »</b> to take a quick tour.'
				].join(""),
				placement: 'bottom'
			},
			{
				element: '.story-toggle',
				title: 'My Stories',
				content: [
